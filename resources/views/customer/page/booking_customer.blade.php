                ...
                <div class="book-left-content input_form">
                        ...
                        <form id="contactBooking" action="{{route('book_table_customer.post')}}" method="post">
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <label for="message"></label><textarea id="message" rows="6" name="note"
                                                                           placeholder="Bạn có điều gì nhà hàng lưu ý?"
                                                                           class="form-control"></textarea>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <button type="submit" class="res-btn">subscribe<i class="fa fa-arrow-right"></i>
                                    </button>
                                </div>
                            </div>
                        </form>
                    @else
                        <form id="contactBooking" action="{{route('book_table.post')}}" method="post">
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <button type="submit" class="res-btn">Xác nhận thông tin<i class="fa fa-arrow-right"></i>
                                    </button>
                                </div>
                            </div>
                        </form>
