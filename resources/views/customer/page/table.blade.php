            ...
            <div class="row">
                ...
                <div class="room-t-wrapper">
                    <div class="col-lg-7 col-md-12 img-wrap">
                        <div class="img-holder"><img src="images\table\1.jpg" alt="" class="img-responsive"></div>
                    </div>
                ...
                <div class="room-t-wrapper room-l-wrapper">
                    ...
                    <div class="col-lg-7 col-md-12 img-wrap">
                        <div class="img-holder"><img src="images\table\nhóm.jpg" width ="1000" class="img-responsive"></div>
                    </div>
                </div>
                <!-- Two-->
                <!-- Three-->
                <div class="room-t-wrapper">
                    <div class="col-lg-7 col-md-12 img-wrap">
                        <div class="img-holder"><img src="images\table\rieng1.jpg" alt="" width="1000" class="img-responsive"></div>
                    </div>
                    <div class="col-lg-5 col-md-12 content">
                        <h2>Phòng Riêng</h2>
                ...
                <div class="room-t-wrapper room-l-wrapper">
                    ...
                    <div class="col-lg-7 col-md-12 img-wrap">
                        <div class="img-holder"><img src="images\table\tiec.jpg" alt="" class="img-responsive"></div>
                    </div>
                </div>
                <!-- Four-->
            </div>
