                    ...
                    <div class="col-sm mb-2 mb-sm-0">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb breadcrumb-no-gutter">
                                ...
                                <li class="breadcrumb-item"><a class="breadcrumb-link" href="javascript:;">Cơ sở vật chất</a></li>
                    ...
                    @foreach($facility as $key=>$val)
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn btn-sm btn-white" href="{{route('facility.delete',$val->facility_id)}}" >
