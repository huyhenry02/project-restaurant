                    ...
                    <div class="col-sm mb-2 mb-sm-0">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb breadcrumb-no-gutter">
                                <li class="breadcrumb-item"><a class="breadcrumb-link" href="">Trang</a>
                                </li>
                                <li class="breadcrumb-item"><a class="breadcrumb-link" href="">Bàn
                                        Đã đặt</a></li>
                        ...
                        <div class="card mb-3 mb-lg-5">
                            ...
                            "placeholder": "Select options"
                                                ...
                                                @foreach($table_type as $key=>$val)
                                                    <option
                                                        value="{{$val->table_type_id ?? ''}}">{{$val->name ?? ''}}</option>
                                                @endforeach
                                            </select>
                                            <!-- End Select -->
